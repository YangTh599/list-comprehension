...
Absolutely! Below are the examples where each one is first written using a **`for` loop with a list** and then rewritten using **list comprehension**, allowing you to directly contrast the two approaches.
